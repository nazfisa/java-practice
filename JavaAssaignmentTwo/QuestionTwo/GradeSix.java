...
public class GradeSix extends SalaryManagement {

    private String name = "Rakib ullah";
    private String grade = "Grade Six";
    private String address = "Feni sadar";
    private String mobileNo = "01827601000";


    private String name1 = "Rakib khan";
    private String grade1 = "Grade Five";
    private String address1 = "Feni sadar";
    private String mobileNo1 = "01827601000";

    private double savings = 0;
    private String accountName = "Ac-010";
    private int accountNumber = 111241;
    private String bank = "Islami bank";
    private String branchName = "ctg";

    private double savings1 = 0;
    private String accountName1 = "Ac-011";
    private int accountNumber1 = 111242;
